import { collectReportViolationAndSuggestionData, findPossibleVariableValues, getContextIdentifiers, getReportInfo, getRuleInfo, isStringLiteral } from "../utils.mjs";

import { getMetaDocsProperty, getRuleInfo } from "../utils.mjs";
...
const rule = {
	...
	create(context) {
		...
		return { Program(ast) {
			...
			const { docsMayHaveUnknownProperties, docsNode, metaNode, metaPropertyNode: descriptionNode } = getMetaDocsProperty("description", ruleInfo, scopeManager);
			if (!descriptionNode) {

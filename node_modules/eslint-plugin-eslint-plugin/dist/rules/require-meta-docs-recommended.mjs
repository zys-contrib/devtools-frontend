import { getMetaDocsProperty, getRuleInfo, isUndefinedIdentifier } from "../utils.mjs";
...
const rule = {
	...
	create(context) {
		...
		const { docsMayHaveUnknownProperties, docsNode, metaNode, metaPropertyNode: descriptionNode } = getMetaDocsProperty("recommended", ruleInfo, scopeManager);
		if (!descriptionNode) {
			if (docsMayHaveUnknownProperties) return {};

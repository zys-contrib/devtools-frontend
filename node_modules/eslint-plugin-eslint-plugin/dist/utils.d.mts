import { ArrowFunctionExpression, AssignmentProperty, CallExpression, Expression, FunctionExpression, Identifier, Node, ObjectExpression, Program, Property, SpreadElement } from "./node_modules/@types/estree/index.mjs";
import { MetaDocsProperty, RuleInfo, StringLiteral, TestInfo, ViolationAndSuppressionData } from "./types.mjs";
 ...
 */
declare function hasUnresolvedObjectSpread(objectNode: Node | undefined, scopeManager: Scope.ScopeManager): boolean;
 ...
 */
declare function getTestInfoProperty(test: Expression | SpreadElement, key: string): Property | null;
/**

...
const typescriptGlobals = [...iterableIterator,
...
var _default = exports.default = (0, _iterateJsdoc.default)(({
  ...
  .concat(cjsOrESMScope ? globalScope.childScopes.flatMap(({
    ...
    return [name];
    /* c8 ignore next */
  }) : []).concat(extraTypes).concat(typedefDeclarations).concat(importTags).concat(definedTypes).concat(tsModuleVariables).concat(/** @type {string[]} */definedPreferredTypes).concat((() => {
